...
#define CELLERATOR_REAL_HAS_CUDA_BF16_HEADER 1
#include <cuda_bf16.h>
#else
#define CELLERATOR_REAL_HAS_CUDA_BF16_HEADER 0
#endif
#if __has_include(<cuda_fp8.h>)
#define CELLERATOR_REAL_HAS_CUDA_FP8_HEADER 1
#include <cuda_fp8.h>
#else
#define CELLERATOR_REAL_HAS_CUDA_FP8_HEADER 0
#endif
#else
#define CELLERATOR_REAL_HAS_CUDA_BF16_HEADER 0
#define CELLERATOR_REAL_HAS_CUDA_FP8_HEADER 0
...
#if defined(__has_include)
#if __has_include(<Cellerator/config.cuh>)
#include <Cellerator/config.cuh>
#define CELLERATOR_REAL_HAS_GENERATED_CONFIG 1
#else
#define CELLERATOR_REAL_HAS_GENERATED_CONFIG 0
#endif
#else
#define CELLERATOR_REAL_HAS_GENERATED_CONFIG 0
#endif

#if !CELLERATOR_REAL_HAS_GENERATED_CONFIG
namespace cellerator::config {
...
static constexpr int has_bf16_types = CELLERATOR_REAL_HAS_CUDA_BF16_HEADER;
static constexpr int has_fp8_types = CELLERATOR_REAL_HAS_CUDA_FP8_HEADER;
...
#if CELLERATOR_REAL_HAS_CUDA_FP8_HEADER
