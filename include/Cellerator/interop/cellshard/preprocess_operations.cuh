...
// Cellerator preprocessing adapters over CellShard device projections.
...
namespace cs_compute_runtime = ::cellerator::runtime;
namespace cs_dist = ::cellerator::dist;
namespace cs_runtime = ::cellshard::runtime;

static constexpr unsigned int CELLERATOR_PREPROCESS_MAX_QC_GROUPS = 32u;
