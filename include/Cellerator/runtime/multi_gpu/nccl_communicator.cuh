...
// Runtime-owned local device resources. The complete type must precede the
// cached-communicator helpers below; the historical include order placed those
// helpers before this definition and broke every NCCL-enabled consumer.
