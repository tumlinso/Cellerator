...
Explicit prerequisites: `CE-NF1-D02`, `CE-NF1-H07`. Earlier entries in the lane queue also apply.
...
1. Three-input product derivatives and repeated-role cases match independent analytic formulas.
2. Pairwise surrogate derivatives or missing repeated-input factors fail tests.
...
Evidence kind: **executed_cuda_test**. Required CTest names: `ce_nf1_d03`.

```sh
python3 -B planning/glasshelix-execution-foundation-v1/scripts/run_gate.py --group d03
```
