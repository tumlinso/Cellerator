...
Explicit prerequisites: `CE-NF1-M00`, `CE-NF1-C06`. Earlier entries in the lane queue also apply.
...
1. Publish CE-NF1 capability contracts with versioned source hashes for GlassHelix X01.
...
- `docs/glasshelix_execution_foundation_v1/records/ce-nf1-m10.json`
...
```sh
python3 -B planning/glasshelix-execution-foundation-v1/scripts/check_record.py --milestone CE-NF1-M10
```
