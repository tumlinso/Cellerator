...
1. Clean host-only configure/build links a standalone consumer.
2. CUDA OFF cannot transitively invoke nvcc or require Torch, CellShard or model targets.
...
Evidence kind: **executed_host_test**. Required CTest names: `ce_nf1_b01`.

```sh
python3 -B planning/glasshelix-execution-foundation-v1/scripts/run_gate.py --group b01
```
