...
Explicit prerequisites: `CE-NF1-H03`, `CE-NF1-N06`, `CE-NF1-P07`. Earlier entries in the lane queue also apply.
...
1. Irregular arity, empty activity and width tails agree with CPU reference.
2. Materializing all cell-by-edge-by-argument values is forbidden unless explicitly selected and costed.
...
Evidence kind: **executed_cuda_test**. Required CTest names: `ce_nf1_h04`.

```sh
python3 -B planning/glasshelix-execution-foundation-v1/scripts/run_gate.py --group h04
```
