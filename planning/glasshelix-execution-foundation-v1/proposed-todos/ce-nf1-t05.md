...
Explicit prerequisites: `CE-NF1-T04`, `CE-NF1-M40`. Earlier entries in the lane queue also apply.
...
1. All required cases execute, with skips and missing binaries treated as failures.
2. No old test is deleted or weakened merely to make a changed contract pass.
...
Evidence kind: **executed_cuda_test**. Required CTest names: `ce_nf1_t05`.

```sh
python3 -B planning/glasshelix-execution-foundation-v1/scripts/run_gate.py --group t05
```
