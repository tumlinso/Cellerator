...
Explicit prerequisites: `CE-NF1-S02`. Earlier entries in the lane queue also apply.
...
1. Masked and compacted outputs agree on identical admitted operations.
2. No speedup claim excludes activity recomputation or sparse projection construction.
...
Evidence kind: **executed_cuda_test**. Required CTest names: `ce_nf1_s03`.

```sh
python3 -B planning/glasshelix-execution-foundation-v1/scripts/run_gate.py --group s03
```
