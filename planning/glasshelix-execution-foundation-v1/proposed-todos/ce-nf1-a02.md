...
Explicit prerequisites: `CE-NF1-A01`. Earlier entries in the lane queue also apply.
...
1. A machine-readable execution binding records verified command/tool contracts without starting work as part of bootstrap.
2. A local child process cannot be counted as a first-class lane; unresolved dispatch or lease capability remains an explicit blocker.
...
- `docs/glasshelix_execution_foundation_v1/records/ce-nf1-a02.json`
...
```sh
python3 -B planning/glasshelix-execution-foundation-v1/scripts/check_record.py --milestone CE-NF1-A02
```
