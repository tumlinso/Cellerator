...
Explicit prerequisites: `CE-NF1-C04`. Earlier entries in the lane queue also apply.
...
1. A consumer-defined nonlinear block joins the existing program path without teaching GlassHelix a new tensor engine.
2. Unknown effects conservatively prevent fusion/reuse; no fake generic JIT or automatic derivative is promised.
...
- `docs/glasshelix_execution_foundation_v1/records/ce-nf1-c05.json`
...
```sh
python3 -B planning/glasshelix-execution-foundation-v1/scripts/check_record.py --milestone CE-NF1-C05
```
