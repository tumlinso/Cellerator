...
Explicit prerequisites: `CE-NF1-V01`. Earlier entries in the lane queue also apply.
...
1. Values can be rebound at a new address/generation without changing topology identity.
2. Physical padding holes never become trainable parameters or valid logical edges.
...
Evidence kind: **executed_host_test**. Required CTest names: `ce_nf1_v02`.

```sh
python3 -B planning/glasshelix-execution-foundation-v1/scripts/run_gate.py --group v02
```
