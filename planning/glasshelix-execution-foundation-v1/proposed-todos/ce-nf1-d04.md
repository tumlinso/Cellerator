...
Explicit prerequisites: `CE-NF1-D03`, `CE-NF1-P07`, `CE-NF1-S07`. Earlier entries in the lane queue also apply.
...
1. Composed transition and observation JVP match finite differences for qualified smooth cases.
2. A held-fixed mask derivative is not advertised as a derivative through a changing discrete selector.
...
Evidence kind: **executed_cuda_test**. Required CTest names: `ce_nf1_d04`.

```sh
python3 -B planning/glasshelix-execution-foundation-v1/scripts/run_gate.py --group d04
```
