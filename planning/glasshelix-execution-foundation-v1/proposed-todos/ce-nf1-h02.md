...
Explicit prerequisites: `CE-NF1-H01`. Earlier entries in the lane queue also apply.
...
1. Consumer-defined evaluators use the same program and binding machinery.
2. No per-cell Python or per-edge virtual callback enters the hot path.
...
Evidence kind: **executed_host_test**. Required CTest names: `ce_nf1_h02`.

```sh
python3 -B planning/glasshelix-execution-foundation-v1/scripts/run_gate.py --group h02
```
