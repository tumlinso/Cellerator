...
Explicit prerequisites: `CE-NF1-P04`. Earlier entries in the lane queue also apply.
...
1. Injected late submission failure cannot produce a valid generation or reusable result.
2. No rollback claim is made after in-place numeric effects have occurred.
...
Evidence kind: **executed_host_test**. Required CTest names: `ce_nf1_p05`.

```sh
python3 -B planning/glasshelix-execution-foundation-v1/scripts/run_gate.py --group p05
```
