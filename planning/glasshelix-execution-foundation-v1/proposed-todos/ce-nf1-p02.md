...
Explicit prerequisites: `CE-NF1-P01`. Earlier entries in the lane queue also apply.
...
1. Invalid final-stage bindings leave all outputs and enqueue counters untouched.
2. Per-stage late checking after prior effects is a regression.
...
Evidence kind: **executed_host_test**. Required CTest names: `ce_nf1_p02`.

```sh
python3 -B planning/glasshelix-execution-foundation-v1/scripts/run_gate.py --group p02
```
