...
Explicit prerequisites: `CE-NF1-C01`. Earlier entries in the lane queue also apply.
...
1. Two value instances can legally bind one prepared structure with independent generations.
2. Equal pointers, equal initial values or common code do not imply parameter tying or historical snapshots.
...
- `docs/glasshelix_execution_foundation_v1/records/ce-nf1-c02.json`
...
```sh
python3 -B planning/glasshelix-execution-foundation-v1/scripts/check_record.py --milestone CE-NF1-C02
```
