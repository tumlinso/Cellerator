...
Explicit prerequisites: `CE-NF1-T03`, `CE-NF1-M30`. Earlier entries in the lane queue also apply.
...
1. Host and device execution work where advertised and unsupported requests fail closed.
2. Header presence, CMake target existence and fake CPU fallback do not count as GPU support.
...
Evidence kind: **executed_cuda_test**. Required CTest names: `ce_nf1_t04`.

```sh
python3 -B planning/glasshelix-execution-foundation-v1/scripts/run_gate.py --group t04
```
