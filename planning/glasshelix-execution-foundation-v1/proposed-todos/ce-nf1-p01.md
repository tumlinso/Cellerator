...
1. Multi-input and multi-output stages execute through the canonical runner.
2. The legacy runner stays covered; GlassHelix cannot acquire parallel scheduler ownership.
...
Evidence kind: **executed_host_test**. Required CTest names: `ce_nf1_p01`.

```sh
python3 -B planning/glasshelix-execution-foundation-v1/scripts/run_gate.py --group p01
```
