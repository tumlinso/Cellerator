...
Explicit prerequisites: `CE-NF1-N01`, `CE-NF1-V07`. Earlier entries in the lane queue also apply.
...
1. Widths 1, 3, 15, 16, 17, 33 and 65 agree with independent references.
2. Padding cannot appear as biological entities or alter output normalization.
...
Evidence kind: **executed_cuda_test**. Required CTest names: `ce_nf1_n02`.

```sh
python3 -B planning/glasshelix-execution-foundation-v1/scripts/run_gate.py --group n02
```
