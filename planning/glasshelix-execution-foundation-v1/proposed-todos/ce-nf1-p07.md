...
Explicit prerequisites: `CE-NF1-P06`, `CE-NF1-B05`, `CE-NF1-N05`. Earlier entries in the lane queue also apply.
...
1. Program execution is real on host and V100, with late-invalid-input no-side-effects proof.
2. A metadata-only stage-graph validator cannot satisfy composed execution.
...
Evidence kind: **executed_cuda_test**. Required CTest names: `ce_nf1_p07`.

```sh
python3 -B planning/glasshelix-execution-foundation-v1/scripts/run_gate.py --group p07
```
