...
Explicit prerequisites: `CE-NF1-N02`. Earlier entries in the lane queue also apply.
...
1. Forward/transpose adjoint consistency holds under matching policy and irregular support.
2. Wrong-order outputs, uninitialized accumulations and illegal aliases fail preflight.
...
Evidence kind: **executed_cuda_test**. Required CTest names: `ce_nf1_n03`.

```sh
python3 -B planning/glasshelix-execution-foundation-v1/scripts/run_gate.py --group n03
```
