...
Explicit prerequisites: `CE-NF1-B01`. Earlier entries in the lane queue also apply.
...
1. External consumer links the actual library implementations through declared targets.
2. A demo that includes a private .cu implementation is rejected as boundary validation.
...
Evidence kind: **executed_host_test**. Required CTest names: `ce_nf1_b02`.

```sh
python3 -B planning/glasshelix-execution-foundation-v1/scripts/run_gate.py --group b02
```
