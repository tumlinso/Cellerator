...
Explicit prerequisites: `CE-NF1-N05`. Earlier entries in the lane queue also apply.
...
1. Separate consumer tests exercise f32 and qualified f16 routes.
2. Schema support without a linked provider cannot advertise an executable capability.
...
Evidence kind: **executed_cuda_test**. Required CTest names: `ce_nf1_n06`.

```sh
python3 -B planning/glasshelix-execution-foundation-v1/scripts/run_gate.py --group n06
```
