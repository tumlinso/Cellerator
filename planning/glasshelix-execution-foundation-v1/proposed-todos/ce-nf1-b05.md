...
Explicit prerequisites: `CE-NF1-B04`. Earlier entries in the lane queue also apply.
...
1. A fresh directory compiles and links a consumer using only supported includes and targets.
2. A same-translation-unit smoke test cannot satisfy external linking.
...
Evidence kind: **executed_host_test**. Required CTest names: `ce_nf1_b05`.

```sh
python3 -B planning/glasshelix-execution-foundation-v1/scripts/run_gate.py --group b05
```
