...
Explicit prerequisites: `CE-NF1-T02`. Earlier entries in the lane queue also apply.
...
1. Unsafe mutations and stale tickets produce deterministic failure before valid-result publication.
2. Launch acceptance alone cannot satisfy completion or sanitizer acceptance.
...
Evidence kind: **executed_host_test**. Required CTest names: `ce_nf1_t03`.

```sh
python3 -B planning/glasshelix-execution-foundation-v1/scripts/run_gate.py --group t03
```
