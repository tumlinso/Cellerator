...
Explicit prerequisites: `CE-NF1-M10`, `CE-NF1-B06`, `CE-NF1-P07`, `CE-NF1-V07`, `CE-NF1-N06`. Earlier entries in the lane queue also apply.
...
1. Host and V100 consumer run shared-structure multi-operand programs with f32 and general width.
...
Evidence kind: **integrated_executed_tests**. Required CTest names: `ce_nf1_external_core_cpu`, `ce_nf1_external_core_cuda`.

```sh
python3 -B planning/glasshelix-execution-foundation-v1/scripts/run_gate.py --group m20
```
