...
Explicit prerequisites: `CE-NF1-M30`. Earlier entries in the lane queue also apply.
...
1. Benchmark receipts distinguish cold, resident and amortized lifetime cost.
2. Kernel-only medians or synthetic counts cannot be presented as application speedup.
...
Evidence kind: **executed_cuda_test**. Required CTest names: `ce_nf1_o01`.

```sh
python3 -B planning/glasshelix-execution-foundation-v1/scripts/run_gate.py --group o01
```
