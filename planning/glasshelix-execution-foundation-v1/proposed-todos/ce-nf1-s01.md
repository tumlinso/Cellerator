...
1. Mask, values and topology have independent invalidation and visible cost.
2. Missing gate dimensions and mask capacity are rejected before writing outputs.
...
Evidence kind: **executed_cuda_test**. Required CTest names: `ce_nf1_s01`.

```sh
python3 -B planning/glasshelix-execution-foundation-v1/scripts/run_gate.py --group s01
```
