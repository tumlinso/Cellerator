...
Explicit prerequisites: `CE-NF1-V06`. Earlier entries in the lane queue also apply.
...
1. Source-linked capability and tests identify actual supported widths and arithmetic.
2. Unsupported stream, capture and device combinations fail before effects.
...
Evidence kind: **executed_cuda_test**. Required CTest names: `ce_nf1_v07`.

```sh
python3 -B planning/glasshelix-execution-foundation-v1/scripts/run_gate.py --group v07
```
