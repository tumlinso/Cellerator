...
Explicit prerequisites: `CE-NF1-C05`. Earlier entries in the lane queue also apply.
...
1. Each required capability has one owner, concrete acceptance and honest unsupported behavior.
2. Contract changes revise the receipt and dependent scopes rather than silently breaking consumers.
...
- `docs/glasshelix_execution_foundation_v1/records/ce-nf1-c06.json`
...
```sh
python3 -B planning/glasshelix-execution-foundation-v1/scripts/check_record.py --milestone CE-NF1-C06
```
