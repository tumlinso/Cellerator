...
Explicit prerequisites: `CE-NF1-P05`. Earlier entries in the lane queue also apply.
...
1. Fused and unfused executions report the same originating numerical operations.
2. Stage IDs are not presented as biological actors or evidence of molecular identity.
...
Evidence kind: **executed_host_test**. Required CTest names: `ce_nf1_p06`.

```sh
python3 -B planning/glasshelix-execution-foundation-v1/scripts/run_gate.py --group p06
```
