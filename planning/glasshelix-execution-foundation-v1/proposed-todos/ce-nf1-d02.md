...
Project: `cellerator`. First-class lane: `CE-NF1-L-D`. Workspace: isolated_merge.
Explicit prerequisites: `CE-NF1-D01`, `CE-NF1-V07`, `CE-NF1-N06`. Earlier entries in the lane queue also apply.
...
1. Mixed/f32 policies are compared under their stated real-operation differentiation convention.
2. Gradient-through-rounding is not silently inferred; f16 storage cannot erase an f32 requested perturbation.
...
- `include/Cellerator/compute/operation/differential`
- `src/compute/operation/differential`
- `tests/native_foundation/differential`
...
Evidence kind: **executed_cuda_test**. Required CTest names: `ce_nf1_d02`.

```sh
python3 -B planning/glasshelix-execution-foundation-v1/scripts/run_gate.py --group d02
```
