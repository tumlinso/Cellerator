...
Explicit prerequisites: `CE-NF1-D04`. Earlier entries in the lane queue also apply.
...
1. VJP duality holds with fan-out, shared subexpressions and multiple outputs.
2. Reusing a later parameter plane for an earlier rollout derivative is rejected.
...
Evidence kind: **executed_cuda_test**. Required CTest names: `ce_nf1_d05`.

```sh
python3 -B planning/glasshelix-execution-foundation-v1/scripts/run_gate.py --group d05
```
