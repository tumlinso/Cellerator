...
Explicit prerequisites: `CE-NF1-A03`. Earlier entries in the lane queue also apply.
...
1. Regression obligations include the retained relation update and existing consumers affected by edits.
2. No reset, broad cleanup, old-run hijack, CE-AMP activation or second numerical runtime is authorized.
...
- `docs/glasshelix_execution_foundation_v1/records/ce-nf1-a04.json`
...
```sh
python3 -B planning/glasshelix-execution-foundation-v1/scripts/check_record.py --milestone CE-NF1-A04
```
