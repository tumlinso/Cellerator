...
Explicit prerequisites: `CE-NF1-A02`. Earlier entries in the lane queue also apply.
...
1. Capability inventory separates schema declarations, implementations, linked targets and executed evidence.
2. No general-width, f32-storage, JVP, n-ary or mutable-capture claim is inferred from a header name.
...
- `docs/glasshelix_execution_foundation_v1/records/ce-nf1-a03.json`
...
```sh
python3 -B planning/glasshelix-execution-foundation-v1/scripts/check_record.py --milestone CE-NF1-A03
```
