...
Explicit prerequisites: `CE-NF1-O03`. Earlier entries in the lane queue also apply.
...
1. Candidate choice reflects full cost and supports tail widths.
2. No universal WMMA promotion or unsupported newer GPU feature is assumed.
...
Evidence kind: **executed_cuda_test**. Required CTest names: `ce_nf1_o04`.

```sh
python3 -B planning/glasshelix-execution-foundation-v1/scripts/run_gate.py --group o04
```
