...
Explicit prerequisites: `CE-NF1-D05`. Earlier entries in the lane queue also apply.
...
1. Analytic polynomial and nonlinear fixtures agree with independent second-direction references.
2. No universal Hessian, automatic derivative of opaque C++ or infinite-jet claim is made.
...
Evidence kind: **executed_cuda_test**. Required CTest names: `ce_nf1_d06`.

```sh
python3 -B planning/glasshelix-execution-foundation-v1/scripts/run_gate.py --group d06
```
