...
1. Repeated and ordered arguments retain semantics under physical reordering.
2. Sorting incidence must not impose commutativity on an arbitrary evaluator.
...
Evidence kind: **executed_host_test**. Required CTest names: `ce_nf1_h01`.

```sh
python3 -B planning/glasshelix-execution-foundation-v1/scripts/run_gate.py --group h01
```
