...
1. Deliberate endpoint permutation and omitted derivative terms are detected.
2. Matching two paths that share the same faulty map is not independent validation.
...
Evidence kind: **executed_host_test**. Required CTest names: `ce_nf1_t01`.

```sh
python3 -B planning/glasshelix-execution-foundation-v1/scripts/run_gate.py --group t01
```
