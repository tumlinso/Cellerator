...
Explicit prerequisites: `CE-NF1-V04`. Earlier entries in the lane queue also apply.
...
1. Only affected preparation is rebuilt after a structural change.
2. Memory reuse cannot make an old ticket valid for a new pair incarnation.
...
Evidence kind: **executed_cuda_test**. Required CTest names: `ce_nf1_v05`.

```sh
python3 -B planning/glasshelix-execution-foundation-v1/scripts/run_gate.py --group v05
```
