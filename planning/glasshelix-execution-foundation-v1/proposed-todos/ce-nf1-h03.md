...
Explicit prerequisites: `CE-NF1-H02`. Earlier entries in the lane queue also apply.
...
1. The nonlinear product of three inputs disagrees with an intentionally incorrect additive pairwise approximation.
2. No dense Cartesian-product interaction enumeration is hidden in preparation.
...
Evidence kind: **executed_host_test**. Required CTest names: `ce_nf1_h03`.

```sh
python3 -B planning/glasshelix-execution-foundation-v1/scripts/run_gate.py --group h03
```
