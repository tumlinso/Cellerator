...
Explicit prerequisites: `CE-NF1-O04`. Earlier entries in the lane queue also apply.
...
1. Report crossover evidence and error assessment with a retained fallback.
2. A faster approximate computation is not mislabeled an exact implementation speedup.
...
Evidence kind: **executed_cuda_test**. Required CTest names: `ce_nf1_o05`.

```sh
python3 -B planning/glasshelix-execution-foundation-v1/scripts/run_gate.py --group o05
```
