...
Explicit prerequisites: `CE-NF1-M30`, `CE-NF1-D08`. Earlier entries in the lane queue also apply.
...
1. Publish linked state/parameter JVP/VJP, selected second directions and stale-primal rejection.
...
Evidence kind: **integrated_executed_tests**. Required CTest names: `ce_nf1_composed_adjoint_cuda`.

```sh
python3 -B planning/glasshelix-execution-foundation-v1/scripts/run_gate.py --group m40
```
