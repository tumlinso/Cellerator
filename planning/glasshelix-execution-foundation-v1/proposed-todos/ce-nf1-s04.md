...
Explicit prerequisites: `CE-NF1-S03`, `CE-NF1-C03`. Earlier entries in the lane queue also apply.
...
1. A zero weight in w*x has zero primal output and correct nonzero parameter derivative.
2. Primal pruning cannot silently remove response support or probability mass.
...
Evidence kind: **executed_cuda_test**. Required CTest names: `ce_nf1_s04`.

```sh
python3 -B planning/glasshelix-execution-foundation-v1/scripts/run_gate.py --group s04
```
