...
Explicit prerequisites: `CE-NF1-O01`, `CE-NF1-M40`. Earlier entries in the lane queue also apply.
...
1. Repeated states and mechanisms reduce measured packing/movement without changing outputs.
2. Same address or same evaluator name cannot justify cache reuse after a value update.
...
Evidence kind: **executed_cuda_test**. Required CTest names: `ce_nf1_o02`.

```sh
python3 -B planning/glasshelix-execution-foundation-v1/scripts/run_gate.py --group o02
```
