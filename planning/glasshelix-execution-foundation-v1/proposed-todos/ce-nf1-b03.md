...
Explicit prerequisites: `CE-NF1-B02`. Earlier entries in the lane queue also apply.
...
1. Record CUDA 12.x/sm70 qualified configuration and host C++20 configuration separately.
2. Do not require CUDA 13 or claim FP8 arithmetic on V100; unavailable toolchains fail with actionable diagnostics.
...
Evidence kind: **executed_host_test**. Required CTest names: `ce_nf1_b03`.

```sh
python3 -B planning/glasshelix-execution-foundation-v1/scripts/run_gate.py --group b03
```
