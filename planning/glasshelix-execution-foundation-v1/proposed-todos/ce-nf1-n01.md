...
1. Independent reference detects deliberately permuted endpoints and incorrect reductions.
2. The oracle must not reuse optimized index maps or the same lowering implementation.
...
Evidence kind: **executed_host_test**. Required CTest names: `ce_nf1_n01`.

```sh
python3 -B planning/glasshelix-execution-foundation-v1/scripts/run_gate.py --group n01
```
