...
Explicit prerequisites: `CE-NF1-C03`. Earlier entries in the lane queue also apply.
...
1. Value, mask and structural changes have separately inspectable invalidation effects.
2. A zero primal contribution does not automatically delete a trainable response path; nonfinite masking semantics remain explicit.
...
- `docs/glasshelix_execution_foundation_v1/records/ce-nf1-c04.json`
...
```sh
python3 -B planning/glasshelix-execution-foundation-v1/scripts/check_record.py --milestone CE-NF1-C04
```
