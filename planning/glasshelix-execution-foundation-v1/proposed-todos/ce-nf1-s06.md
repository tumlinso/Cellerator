...
Explicit prerequisites: `CE-NF1-S05`. Earlier entries in the lane queue also apply.
...
1. Pruned output error and eligibility domain are recorded separately from structural absence.
2. A fitted near-zero value is not a causal absence claim or a universally valid reduction.
...
Evidence kind: **executed_cuda_test**. Required CTest names: `ce_nf1_s06`.

```sh
python3 -B planning/glasshelix-execution-foundation-v1/scripts/run_gate.py --group s06
```
