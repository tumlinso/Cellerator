# CE-RU1-F04: Close compiler conformance and remove on-path duplicate mappings

Lane: `CE-RU1-L-FRONTEND`. Status on delivery: **planned**, not claimed or implemented.
Dependencies: `CE-RU1-F03`

## Goal and implementation direction

Consolidate targeted negative and positive tests and document what the embedded source bridge does not compile. Identify dead adapters to retire at integration only after references/builds are audited. Record deferred full .cell/import/cross-TU/IR work without creating another epic or changing Todo authority.
...
- `tests/relation_update_spine_v1/compiler_conformance_test.cc`
- `docs/relation_update_spine_v1/compiler_boundary.md`
...
1. All supported closure effects have conformance tests tied to shared semantics; no fabricated substitute primitive remains on this path.
2. Deferred language features are explicitly listed and not advertised as working.

## Required validation cases

- Contract suite for both delta and gradient-step source forms; unsupported syntax remains failure.
...
Broad syntax completion would dilute this computation-focused epic.
