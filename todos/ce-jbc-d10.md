...
## Objective
Implement support-contraction embedding-dimension decomposition. Deliver this as one isolated, reviewable step in the Biological operation decomposition and partial algebra workstream.
...
- `exclusive`: `src/compute/decomposition`
- `exclusive`: `tests/jbc/decomposition`
