...
- `CE-JBC-B01` | kind: task | status: planned | parent: - | objective: Revalidate live Cellerator, submodule, and Todo cursors. Deliver this as one isolated, reviewable step in the Cellerator baseline, charter, and source ownership workstream.
- `CE-JBC-B02` | kind: task | status: planned | parent: - | objective: Produce the source-backed Cellerator transition map. Deliver this as one isolated, reviewable step in the Cellerator baseline, charter, and source ownership workstream.
- `CE-JBC-B03` | kind: task | status: planned | parent: - | objective: Freeze the privileged compiler-component charter. Deliver this as one isolated, reviewable step in the Cellerator baseline, charter, and source ownership workstream.
- `CE-JBC-B04` | kind: task | status: planned | parent: - | objective: Record standalone and embedded build baselines. Deliver this as one isolated, reviewable step in the Cellerator baseline, charter, and source ownership workstream.
...
- `CE-JBC-C03` | kind: task | status: planned | parent: - | objective: Inject global reuse and movement prices into geometry objectives. Deliver this as one isolated, reviewable step in the External global costs and bounded joint compiler exchange workstream.
- `CE-JBC-C04` | kind: task | status: planned | parent: - | objective: Implement one-pass external-cost frontier. Deliver this as one isolated, reviewable step in the External global costs and bounded joint compiler exchange workstream.
- `CE-JBC-C05` | kind: task | status: planned | parent: - | objective: Implement bounded Cellerator–caller compiler exchange. Deliver this as one isolated, reviewable step in the External global costs and bounded joint compiler exchange workstream.
- `CE-JBC-C06` | kind: task | status: planned | parent: - | objective: Implement experimental local pricing oracle for column generation. Deliver this as one isolated, reviewable step in the External global costs and bounded joint compiler exchange workstream.
- `CE-JBC-D01` | kind: task | status: planned | parent: - | objective: Define split-axis and decomposition vocabulary. Deliver this as one isolated, reviewable step in the Biological operation decomposition and partial algebra workstream.
- `CE-JBC-D02` | kind: task | status: planned | parent: - | objective: Implement destination-disjoint relation-apply decomposition. Deliver this as one isolated, reviewable step in the Biological operation decomposition and partial algebra workstream.
- `CE-JBC-D03` | kind: task | status: planned | parent: - | objective: Implement source/K relation-apply decomposition. Deliver this as one isolated, reviewable step in the Biological operation decomposition and partial algebra workstream.
- `CE-JBC-D04` | kind: task | status: planned | parent: - | objective: Implement dense-width relation-apply decomposition. Deliver this as one isolated, reviewable step in the Biological operation decomposition and partial algebra workstream.
- `CE-JBC-D05` | kind: task | status: planned | parent: - | objective: Implement edge/component relation-apply decomposition. Deliver this as one isolated, reviewable step in the Biological operation decomposition and partial algebra workstream.
- `CE-JBC-D06` | kind: task | status: planned | parent: - | objective: Implement relation-bundle/type decomposition. Deliver this as one isolated, reviewable step in the Biological operation decomposition and partial algebra workstream.
- `CE-JBC-D07` | kind: task | status: planned | parent: - | objective: Implement transpose decomposition and source partials. Deliver this as one isolated, reviewable step in the Biological operation decomposition and partial algebra workstream.
- `CE-JBC-D08` | kind: task | status: planned | parent: - | objective: Implement support-contraction destination/source decomposition. Deliver this as one isolated, reviewable step in the Biological operation decomposition and partial algebra workstream.
- `CE-JBC-D09` | kind: task | status: planned | parent: - | objective: Implement support-contraction edge/rectangle decomposition. Deliver this as one isolated, reviewable step in the Biological operation decomposition and partial algebra workstream.
- `CE-JBC-D10` | kind: task | status: planned | parent: - | objective: Implement support-contraction embedding-dimension decomposition. Deliver this as one isolated, reviewable step in the Biological operation decomposition and partial algebra workstream.
- `CE-JBC-D11` | kind: task | status: planned | parent: - | objective: Implement segment-disjoint decomposition. Deliver this as one isolated, reviewable step in the Biological operation decomposition and partial algebra workstream.
- `CE-JBC-D12` | kind: task | status: planned | parent: - | objective: Implement split-segment reduction decomposition. Deliver this as one isolated, reviewable step in the Biological operation decomposition and partial algebra workstream.
- `CE-JBC-D13` | kind: task | status: planned | parent: - | objective: Implement mergeable log-sum-exp and softmax state. Deliver this as one isolated, reviewable step in the Biological operation decomposition and partial algebra workstream.
- `CE-JBC-D14` | kind: task | status: planned | parent: - | objective: Implement mergeable moments state. Deliver this as one isolated, reviewable step in the Biological operation decomposition and partial algebra workstream.
- `CE-JBC-D15` | kind: task | status: planned | parent: - | objective: Define gate-dependent input and replication semantics. Deliver this as one isolated, reviewable step in the Biological operation decomposition and partial algebra workstream.
- `CE-JBC-D16` | kind: task | status: planned | parent: - | objective: Define sparse-update conflict and ordering algebra. Deliver this as one isolated, reviewable step in the Biological operation decomposition and partial algebra workstream.
- `CE-JBC-D17` | kind: task | status: planned | parent: - | objective: Define training and gradient decomposition contracts. Deliver this as one isolated, reviewable step in the Biological operation decomposition and partial algebra workstream.
- `CE-JBC-D18` | kind: task | status: planned | parent: - | objective: Register and independently validate decomposition providers. Deliver this as one isolated, reviewable step in the Biological operation decomposition and partial algebra workstream.
- `CE-JBC-F01` | kind: task | status: planned | parent: - | objective: Implement atom-fragment requirements query. Deliver this as one isolated, reviewable step in the Atom-aware Cellerator fragment compiler workstream.
- `CE-JBC-F02` | kind: task | status: planned | parent: - | objective: Adapt operation_core_v2 problems to fragment compilation. Deliver this as one isolated, reviewable step in the Atom-aware Cellerator fragment compiler workstream.
- `CE-JBC-F03` | kind: task | status: planned | parent: - | objective: Build atom-local hierarchical index spaces. Deliver this as one isolated, reviewable step in the Atom-aware Cellerator fragment compiler workstream.
- `CE-JBC-F04` | kind: task | status: planned | parent: - | objective: Validate externally supplied exact decomposition. Deliver this as one isolated, reviewable step in the Atom-aware Cellerator fragment compiler workstream.
- `CE-JBC-F05` | kind: task | status: planned | parent: - | objective: Validate externally supplied persistent order. Deliver this as one isolated, reviewable step in the Atom-aware Cellerator fragment compiler workstream.
- `CE-JBC-F06` | kind: task | status: planned | parent: - | objective: Extract atom requirements from local candidates. Deliver this as one isolated, reviewable step in the Atom-aware Cellerator fragment compiler workstream.
- `CE-JBC-F07` | kind: task | status: planned | parent: - | objective: Discover atom-bound local candidates. Deliver this as one isolated, reviewable step in the Atom-aware Cellerator fragment compiler workstream.
- `CE-JBC-F08` | kind: task | status: planned | parent: - | objective: Retain a bounded local Pareto frontier. Deliver this as one isolated, reviewable step in the Atom-aware Cellerator fragment compiler workstream.
- `CE-JBC-F09` | kind: task | status: planned | parent: - | objective: Wrap program_v2 as prepared atom fragment. Deliver this as one isolated, reviewable step in the Atom-aware Cellerator fragment compiler workstream.
- `CE-JBC-F10` | kind: task | status: planned | parent: - | objective: Bind external atom planes and lease tokens. Deliver this as one isolated, reviewable step in the Atom-aware Cellerator fragment compiler workstream.
- `CE-JBC-F11` | kind: task | status: planned | parent: - | objective: Describe output atom and partial affordances. Deliver this as one isolated, reviewable step in the Atom-aware Cellerator fragment compiler workstream.
- `CE-JBC-F12` | kind: task | status: planned | parent: - | objective: Implement canonical fallback and diagnostics. Deliver this as one isolated, reviewable step in the Atom-aware Cellerator fragment compiler workstream.
- `CE-JBC-F13` | kind: task | status: planned | parent: - | objective: Register source-linked fragment compilers. Deliver this as one isolated, reviewable step in the Atom-aware Cellerator fragment compiler workstream.
- `CE-JBC-F14` | kind: task | status: planned | parent: - | objective: Execute canonical relation-apply atom-fragment smoke. Deliver this as one isolated, reviewable step in the Atom-aware Cellerator fragment compiler workstream.
- `CE-JBC-I01` | kind: task | status: planned | parent: - | objective: Define a namespace-qualified persistent identity bridge. Deliver this as one isolated, reviewable step in the Cellerator-owned joint-compiler thin-waist interfaces workstream.
- `CE-JBC-I02` | kind: task | status: planned | parent: - | objective: Define exact logical coverage view v1. Deliver this as one isolated, reviewable step in the Cellerator-owned joint-compiler thin-waist interfaces workstream.
- `CE-JBC-I03` | kind: task | status: planned | parent: - | objective: Define ownership, proposal, replica, and halo coverage roles. Deliver this as one isolated, reviewable step in the Cellerator-owned joint-compiler thin-waist interfaces workstream.
- `CE-JBC-I04` | kind: task | status: planned | parent: - | objective: Define atom requirement descriptor v1. Deliver this as one isolated, reviewable step in the Cellerator-owned joint-compiler thin-waist interfaces workstream.
- `CE-JBC-I05` | kind: task | status: planned | parent: - | objective: Define atom affordance descriptor v1. Deliver this as one isolated, reviewable step in the Cellerator-owned joint-compiler thin-waist interfaces workstream.
- `CE-JBC-I06` | kind: task | status: planned | parent: - | objective: Define partial-result algebra ABI v1. Deliver this as one isolated, reviewable step in the Cellerator-owned joint-compiler thin-waist interfaces workstream.
- `CE-JBC-I07` | kind: task | status: planned | parent: - | objective: Define operation decomposition alternative ABI v1. Deliver this as one isolated, reviewable step in the Cellerator-owned joint-compiler thin-waist interfaces workstream.
- `CE-JBC-I08` | kind: task | status: planned | parent: - | objective: Define atom-fragment request ABI v1. Deliver this as one isolated, reviewable step in the Cellerator-owned joint-compiler thin-waist interfaces workstream.
- `CE-JBC-I09` | kind: task | status: planned | parent: - | objective: Define atom-fragment candidate and result ABI v1. Deliver this as one isolated, reviewable step in the Cellerator-owned joint-compiler thin-waist interfaces workstream.
- `CE-JBC-I10` | kind: task | status: planned | parent: - | objective: Define multi-extent external binding ABI v1. Deliver this as one isolated, reviewable step in the Cellerator-owned joint-compiler thin-waist interfaces workstream.
- `CE-JBC-I11` | kind: task | status: planned | parent: - | objective: Define lowering-resumption ABI v1. Deliver this as one isolated, reviewable step in the Cellerator-owned joint-compiler thin-waist interfaces workstream.
- `CE-JBC-I12` | kind: task | status: planned | parent: - | objective: Extend generic execution export to atom-aware v2. Deliver this as one isolated, reviewable step in the Cellerator-owned joint-compiler thin-waist interfaces workstream.
- `CE-JBC-M01` | kind: task | status: planned | parent: - | objective: Define multi-atom port binding list. Deliver this as one isolated, reviewable step in the Multi-atom and multi-extent Cellerator operands workstream.
- `CE-JBC-M02` | kind: task | status: planned | parent: - | objective: Define multi-extent physical binding list. Deliver this as one isolated, reviewable step in the Multi-atom and multi-extent Cellerator operands workstream.
- `CE-JBC-M03` | kind: task | status: planned | parent: - | objective: Query contiguity, alignment, and extent requirements. Deliver this as one isolated, reviewable step in the Multi-atom and multi-extent Cellerator operands workstream.
- `CE-JBC-M04` | kind: task | status: planned | parent: - | objective: Compile the explicit contiguous-assembly baseline. Deliver this as one isolated, reviewable step in the Multi-atom and multi-extent Cellerator operands workstream.
- `CE-JBC-M05` | kind: task | status: planned | parent: - | objective: Implement reusable gather, scatter, and permutation operations. Deliver this as one isolated, reviewable step in the Multi-atom and multi-extent Cellerator operands workstream.
- `CE-JBC-M06` | kind: task | status: planned | parent: - | objective: Define the direct multi-extent candidate contract. Deliver this as one isolated, reviewable step in the Multi-atom and multi-extent Cellerator operands workstream.
- `CE-JBC-M07` | kind: task | status: planned | parent: - | objective: Implement an experimental multi-extent relation-apply candidate. Deliver this as one isolated, reviewable step in the Multi-atom and multi-extent Cellerator operands workstream.
- `CE-JBC-M08` | kind: task | status: planned | parent: - | objective: Bind a structural atom plus mutable value overlay. Deliver this as one isolated, reviewable step in the Multi-atom and multi-extent Cellerator operands workstream.
- `CE-JBC-M09` | kind: task | status: planned | parent: - | objective: Integrate chunk-native projection acquisition. Deliver this as one isolated, reviewable step in the Multi-atom and multi-extent Cellerator operands workstream.
- `CE-JBC-M10` | kind: task | status: planned | parent: - | objective: Benchmark assembly versus direct multi-extent execution. Deliver this as one isolated, reviewable step in the Multi-atom and multi-extent Cellerator operands workstream.
- `CE-JBC-P01` | kind: task | status: planned | parent: - | objective: Map CellShard atom planes to projection_value_plane_v1. Deliver this as one isolated, reviewable step in the Cellerator atom planes, mutable values, gradients, and atom outputs workstream.
- `CE-JBC-P02` | kind: task | status: planned | parent: - | objective: Define structural atom-plane binding. Deliver this as one isolated, reviewable step in the Cellerator atom planes, mutable values, gradients, and atom outputs workstream.
- `CE-JBC-P03` | kind: task | status: planned | parent: - | objective: Define mutable relation-value atom plane. Deliver this as one isolated, reviewable step in the Cellerator atom planes, mutable values, gradients, and atom outputs workstream.
- `CE-JBC-P04` | kind: task | status: planned | parent: - | objective: Define active-support overlay atom plane. Deliver this as one isolated, reviewable step in the Cellerator atom planes, mutable values, gradients, and atom outputs workstream.
- `CE-JBC-P05` | kind: task | status: planned | parent: - | objective: Define mutable state atom plane. Deliver this as one isolated, reviewable step in the Cellerator atom planes, mutable values, gradients, and atom outputs workstream.
- `CE-JBC-P06` | kind: task | status: planned | parent: - | objective: Define gradient atom plane. Deliver this as one isolated, reviewable step in the Cellerator atom planes, mutable values, gradients, and atom outputs workstream.
- `CE-JBC-P07` | kind: task | status: planned | parent: - | objective: Bind generation_publication_v1 to atom generations. Deliver this as one isolated, reviewable step in the Cellerator atom planes, mutable values, gradients, and atom outputs workstream.
- `CE-JBC-P08` | kind: task | status: planned | parent: - | objective: Emit persistent-order dense result atoms. Deliver this as one isolated, reviewable step in the Cellerator atom planes, mutable values, gradients, and atom outputs workstream.
- `CE-JBC-P09` | kind: task | status: planned | parent: - | objective: Emit partial-result atoms. Deliver this as one isolated, reviewable step in the Cellerator atom planes, mutable values, gradients, and atom outputs workstream.
- `CE-JBC-P10` | kind: task | status: planned | parent: - | objective: Define neutral ready-event and lease binding. Deliver this as one isolated, reviewable step in the Cellerator atom planes, mutable values, gradients, and atom outputs workstream.
- `CE-JBC-R01` | kind: task | status: planned | parent: - | objective: Define lowering-stage and compatibility status taxonomy. Deliver this as one isolated, reviewable step in the Cellerator lowering-resumption contracts workstream.
- `CE-JBC-R02` | kind: task | status: planned | parent: - | objective: Resume from canonical source input. Deliver this as one isolated, reviewable step in the Cellerator lowering-resumption contracts workstream.
- `CE-JBC-R03` | kind: task | status: planned | parent: - | objective: Resume from atom-evidence artifact. Deliver this as one isolated, reviewable step in the Cellerator lowering-resumption contracts workstream.
- `CE-JBC-R04` | kind: task | status: planned | parent: - | objective: Resume from semantic atom or basis artifact. Deliver this as one isolated, reviewable step in the Cellerator lowering-resumption contracts workstream.
- `CE-JBC-R05` | kind: task | status: planned | parent: - | objective: Resume from target-cover artifact. Deliver this as one isolated, reviewable step in the Cellerator lowering-resumption contracts workstream.
- `CE-JBC-R06` | kind: task | status: planned | parent: - | objective: Resume from physical projection or CPE2 artifact. Deliver this as one isolated, reviewable step in the Cellerator lowering-resumption contracts workstream.
- `CE-JBC-R07` | kind: task | status: planned | parent: - | objective: Resume from packed value or operand artifact. Deliver this as one isolated, reviewable step in the Cellerator lowering-resumption contracts workstream.
- `CE-JBC-R08` | kind: task | status: planned | parent: - | objective: Resume from executable atom recipe. Deliver this as one isolated, reviewable step in the Cellerator lowering-resumption contracts workstream.
- `CE-JBC-R09` | kind: task | status: planned | parent: - | objective: Validate topology-linked local realization. Deliver this as one isolated, reviewable step in the Cellerator lowering-resumption contracts workstream.
- `CE-JBC-R10` | kind: task | status: planned | parent: - | objective: Instrument phase bypass and earliest-compatible fallback. Deliver this as one isolated, reviewable step in the Cellerator lowering-resumption contracts workstream.
- `CE-JBC-V01` | kind: task | status: planned | parent: - | objective: Implement an independent atom-fragment structural verifier. Deliver this as one isolated, reviewable step in the Cellerator exact verification, profiling, packaging, and integration workstream.
- `CE-JBC-V02` | kind: task | status: planned | parent: - | objective: Implement scalable exact reconstruction and numerical verification. Deliver this as one isolated, reviewable step in the Cellerator exact verification, profiling, packaging, and integration workstream.
...
- `CE-JBC-X04` | kind: task | status: planned | parent: - | objective: Build the support-contraction physical view. Deliver this as one isolated, reviewable step in the Cross-operation Cellerator projection families workstream.
- `CE-JBC-X05` | kind: task | status: planned | parent: - | objective: Build segment and gate physical views. Deliver this as one isolated, reviewable step in the Cross-operation Cellerator projection families workstream.
- `CE-JBC-X06` | kind: task | status: planned | parent: - | objective: Build the shared value and gradient identity spine. Deliver this as one isolated, reviewable step in the Cross-operation Cellerator projection families workstream.
- `CE-JBC-X07` | kind: task | status: planned | parent: - | objective: Compare specialized and generalized view families. Deliver this as one isolated, reviewable step in the Cross-operation Cellerator projection families workstream.
- `CE-JBC-X08` | kind: task | status: planned | parent: - | objective: Emit cross-operation Pareto frontier and promotion disposition. Deliver this as one isolated, reviewable step in the Cross-operation Cellerator projection families workstream.
