...
- `CE-EXOP-11` | kind: workstream | status: planned | parent: CE-EXOP-00 | objective: Deliver implement provider-selection and tuning controls exactly within the contracts, boundaries, evidence rules, and deferred-work limits in docs/CE_EXOP_PROGRAM.md.
...
- `CE-EXOP-12` | kind: workstream | status: planned | parent: CE-EXOP-00 | objective: Deliver split generic/common/sm70 build targets and manifest exactly within the contracts, boundaries, evidence rules, and deferred-work limits in docs/CE_EXOP_PROGRAM.md.
...
- `CE-EXOP-13` | kind: workstream | status: planned | parent: CE-EXOP-00 | objective: Deliver implement precise, experimental, and profiling build policy exactly within the contracts, boundaries, evidence rules, and deferred-work limits in docs/CE_EXOP_PROGRAM.md.
...
- `CE-EXOP-14` | kind: validation_task | status: planned | parent: CE-EXOP-00 | objective: Deliver validate build and packaging matrix exactly within the contracts, boundaries, evidence rules, and deferred-work limits in docs/CE_EXOP_PROGRAM.md.
...
- `CE-EXOP-15` | kind: workstream | status: planned | parent: CE-EXOP-00 | objective: Deliver freeze provider-build interface exactly within the contracts, boundaries, evidence rules, and deferred-work limits in docs/CE_EXOP_PROGRAM.md.
...
- `CE-EXOP-20` | kind: workstream | status: planned | parent: CE-EXOP-00 | objective: Deliver hierarchical index-space contract exactly within the contracts, boundaries, evidence rules, and deferred-work limits in docs/CE_EXOP_PROGRAM.md.
...
- `CE-EXOP-21` | kind: workstream | status: planned | parent: CE-EXOP-00 | objective: Deliver scalable work, support, cover, and map views exactly within the contracts, boundaries, evidence rules, and deferred-work limits in docs/CE_EXOP_PROGRAM.md.
...
- `CE-EXOP-22` | kind: workstream | status: planned | parent: CE-EXOP-00 | objective: Deliver linear validation and construction substrate exactly within the contracts, boundaries, evidence rules, and deferred-work limits in docs/CE_EXOP_PROGRAM.md.
...
- `CE-EXOP-23` | kind: workstream | status: planned | parent: CE-EXOP-00 | objective: Deliver chunked semantic and physical payload manifests exactly within the contracts, boundaries, evidence rules, and deferred-work limits in docs/CE_EXOP_PROGRAM.md.
...
- `CE-EXOP-24` | kind: workstream | status: planned | parent: CE-EXOP-00 | objective: Deliver chunked gpu dispatch and local-index execution exactly within the contracts, boundaries, evidence rules, and deferred-work limits in docs/CE_EXOP_PROGRAM.md.
...
- `CE-EXOP-25` | kind: workstream | status: planned | parent: CE-EXOP-00 | objective: Deliver migrate central ce-geo scale limitations exactly within the contracts, boundaries, evidence rules, and deferred-work limits in docs/CE_EXOP_PROGRAM.md.
...
- `CE-EXOP-26` | kind: workstream | status: planned | parent: CE-EXOP-00 | objective: Deliver freeze scalable indexing and geometry exactly within the contracts, boundaries, evidence rules, and deferred-work limits in docs/CE_EXOP_PROGRAM.md.
...
- `CE-EXOP-30` | kind: workstream | status: planned | parent: CE-EXOP-00 | objective: Deliver define operation-core schema v2 exactly within the contracts, boundaries, evidence rules, and deferred-work limits in docs/CE_EXOP_PROGRAM.md.
- `CE-EXOP-31` | kind: workstream | status: planned | parent: CE-EXOP-00 | objective: Deliver encode complete relation algebra and bindings exactly within the contracts, boundaries, evidence rules, and deferred-work limits in docs/CE_EXOP_PROGRAM.md.
- `CE-EXOP-32` | kind: workstream | status: planned | parent: CE-EXOP-00 | objective: Deliver encode output, order, numerical, and determinism contracts exactly within the contracts, boundaries, evidence rules, and deferred-work limits in docs/CE_EXOP_PROGRAM.md.
- `CE-EXOP-33` | kind: workstream | status: planned | parent: CE-EXOP-00 | objective: Deliver add sparse-axis update and composition descriptors exactly within the contracts, boundaries, evidence rules, and deferred-work limits in docs/CE_EXOP_PROGRAM.md.
- `CE-EXOP-34` | kind: workstream | status: planned | parent: CE-EXOP-00 | objective: Deliver add v1 adapters and migrate persistent problem identity exactly within the contracts, boundaries, evidence rules, and deferred-work limits in docs/CE_EXOP_PROGRAM.md.
- `CE-EXOP-35` | kind: workstream | status: planned | parent: CE-EXOP-00 | objective: Deliver freeze operation-core v2 exactly within the contracts, boundaries, evidence rules, and deferred-work limits in docs/CE_EXOP_PROGRAM.md.
- `CE-EXOP-40` | kind: workstream | status: planned | parent: CE-EXOP-00 | objective: Deliver candidate catalog v3 contract exactly within the contracts, boundaries, evidence rules, and deferred-work limits in docs/CE_EXOP_PROGRAM.md.
...
- `CE-EXOP-41` | kind: workstream | status: planned | parent: CE-EXOP-00 | objective: Deliver assemble broad provider and relation-operation inventory exactly within the contracts, boundaries, evidence rules, and deferred-work limits in docs/CE_EXOP_PROGRAM.md.
...
- `CE-EXOP-42` | kind: workstream | status: planned | parent: CE-EXOP-00 | objective: Deliver make program v2 the sole internal production engine exactly within the contracts, boundaries, evidence rules, and deferred-work limits in docs/CE_EXOP_PROGRAM.md.
...
- `CE-EXOP-43` | kind: workstream | status: planned | parent: CE-EXOP-00 | objective: Deliver thin v1 wrappers and migrate production call sites exactly within the contracts, boundaries, evidence rules, and deferred-work limits in docs/CE_EXOP_PROGRAM.md.
...
- `CE-EXOP-44` | kind: validation_task | status: planned | parent: CE-EXOP-00 | objective: Deliver catalog/program validation exactly within the contracts, boundaries, evidence rules, and deferred-work limits in docs/CE_EXOP_PROGRAM.md.
...
- `CE-EXOP-45` | kind: workstream | status: planned | parent: CE-EXOP-00 | objective: Deliver freeze catalog/program contracts exactly within the contracts, boundaries, evidence rules, and deferred-work limits in docs/CE_EXOP_PROGRAM.md.
...
- `CE-EXOP-50` | kind: workstream | status: planned | parent: CE-EXOP-00 | objective: Deliver caller-owned candidate workspace exactly within the contracts, boundaries, evidence rules, and deferred-work limits in docs/CE_EXOP_PROGRAM.md.
...
- `CE-EXOP-51` | kind: workstream | status: planned | parent: CE-EXOP-00 | objective: Deliver resource, mechanism, and stage-aware planning exactly within the contracts, boundaries, evidence rules, and deferred-work limits in docs/CE_EXOP_PROGRAM.md.
...
- `CE-EXOP-52` | kind: workstream | status: planned | parent: CE-EXOP-00 | objective: Deliver pareto portfolio and experimental selection policy exactly within the contracts, boundaries, evidence rules, and deferred-work limits in docs/CE_EXOP_PROGRAM.md.
...
- `CE-EXOP-53` | kind: workstream | status: planned | parent: CE-EXOP-00 | objective: Deliver layout, value-mode, reuse, and connected-operation economics exactly within the contracts, boundaries, evidence rules, and deferred-work limits in docs/CE_EXOP_PROGRAM.md.
...
- `CE-EXOP-54` | kind: validation_task | status: planned | parent: CE-EXOP-00 | objective: Deliver planner correctness and scale tests exactly within the contracts, boundaries, evidence rules, and deferred-work limits in docs/CE_EXOP_PROGRAM.md.
...
- `CE-EXOP-55` | kind: workstream | status: planned | parent: CE-EXOP-00 | objective: Deliver freeze planner portfolio exactly within the contracts, boundaries, evidence rules, and deferred-work limits in docs/CE_EXOP_PROGRAM.md.
...
- `CE-EXOP-60` | kind: workstream | status: planned | parent: CE-EXOP-00 | objective: Deliver requirements-query acquisition facade exactly within the contracts, boundaries, evidence rules, and deferred-work limits in docs/CE_EXOP_PROGRAM.md.
...
- `CE-EXOP-61` | kind: workstream | status: planned | parent: CE-EXOP-00 | objective: Deliver default registry, provider, catalog, and planner assembly exactly within the contracts, boundaries, evidence rules, and deferred-work limits in docs/CE_EXOP_PROGRAM.md.
...
- `CE-EXOP-62` | kind: workstream | status: planned | parent: CE-EXOP-00 | objective: Deliver multiple projections, chunking, and explicit fallback exactly within the contracts, boundaries, evidence rules, and deferred-work limits in docs/CE_EXOP_PROGRAM.md.
...
- `CE-EXOP-63` | kind: workstream | status: planned | parent: CE-EXOP-00 | objective: Deliver generic external-consumer boundary and tests exactly within the contracts, boundaries, evidence rules, and deferred-work limits in docs/CE_EXOP_PROGRAM.md.
...
- `CE-EXOP-64` | kind: workstream | status: planned | parent: CE-EXOP-00 | objective: Deliver freeze acquisition v2 exactly within the contracts, boundaries, evidence rules, and deferred-work limits in docs/CE_EXOP_PROGRAM.md.
...
- `CE-EXOP-70` | kind: workstream | status: planned | parent: CE-EXOP-00 | objective: Deliver mechanism and prepared-stage manifest exactly within the contracts, boundaries, evidence rules, and deferred-work limits in docs/CE_EXOP_PROGRAM.md.
...
- `CE-EXOP-71` | kind: workstream | status: planned | parent: CE-EXOP-00 | objective: Deliver resource receipts and stable profiling identities exactly within the contracts, boundaries, evidence rules, and deferred-work limits in docs/CE_EXOP_PROGRAM.md.
...
- `CE-EXOP-72` | kind: workstream | status: planned | parent: CE-EXOP-00 | objective: Deliver optional static profiling markers and unique kernel names exactly within the contracts, boundaries, evidence rules, and deferred-work limits in docs/CE_EXOP_PROGRAM.md.
...
- `CE-EXOP-73` | kind: workstream | status: planned | parent: CE-EXOP-00 | objective: Deliver generic partition/order/resource export exactly within the contracts, boundaries, evidence rules, and deferred-work limits in docs/CE_EXOP_PROGRAM.md.
...
- `CE-EXOP-74` | kind: validation_task | status: planned | parent: CE-EXOP-00 | objective: Deliver prove disabled profiling does not alter the hot path exactly within the contracts, boundaries, evidence rules, and deferred-work limits in docs/CE_EXOP_PROGRAM.md.
...
- `CE-EXOP-75` | kind: workstream | status: planned | parent: CE-EXOP-00 | objective: Deliver freeze profiling interfaces exactly within the contracts, boundaries, evidence rules, and deferred-work limits in docs/CE_EXOP_PROGRAM.md.
...
- `CE-EXOP-80` | kind: workstream | status: planned | parent: CE-EXOP-00 | objective: Deliver workload profile v2 exactly within the contracts, boundaries, evidence rules, and deferred-work limits in docs/CE_EXOP_PROGRAM.md.
- `CE-EXOP-81` | kind: workstream | status: planned | parent: CE-EXOP-00 | objective: Deliver original-group and incremental work-window semantics exactly within the contracts, boundaries, evidence rules, and deferred-work limits in docs/CE_EXOP_PROGRAM.md.
- `CE-EXOP-82` | kind: workstream | status: planned | parent: CE-EXOP-00 | objective: Deliver semantic and target-cover strategy registries exactly within the contracts, boundaries, evidence rules, and deferred-work limits in docs/CE_EXOP_PROGRAM.md.
- `CE-EXOP-83` | kind: workstream | status: planned | parent: CE-EXOP-00 | objective: Deliver independent exact evaluator and incremental state exactly within the contracts, boundaries, evidence rules, and deferred-work limits in docs/CE_EXOP_PROGRAM.md.
- `CE-EXOP-84` | kind: workstream | status: planned | parent: CE-EXOP-00 | objective: Deliver multi-candidate solution and snapshot contracts exactly within the contracts, boundaries, evidence rules, and deferred-work limits in docs/CE_EXOP_PROGRAM.md.
- `CE-EXOP-85` | kind: workstream | status: planned | parent: CE-EXOP-00 | objective: Deliver freeze geometry optimizer contracts exactly within the contracts, boundaries, evidence rules, and deferred-work limits in docs/CE_EXOP_PROGRAM.md.
- `CE-EXOP-90` | kind: workstream | status: planned | parent: CE-EXOP-00 | objective: Deliver mutable joint grouping state exactly within the contracts, boundaries, evidence rules, and deferred-work limits in docs/CE_EXOP_PROGRAM.md.
...
- `CE-EXOP-91` | kind: workstream | status: planned | parent: CE-EXOP-00 | objective: Deliver actual joint source/destination grouping exactly within the contracts, boundaries, evidence rules, and deferred-work limits in docs/CE_EXOP_PROGRAM.md.
...
- `CE-EXOP-92` | kind: workstream | status: planned | parent: CE-EXOP-00 | objective: Deliver incremental exact moves and residual-aware refinement exactly within the contracts, boundaries, evidence rules, and deferred-work limits in docs/CE_EXOP_PROGRAM.md.
...
- `CE-EXOP-93` | kind: workstream | status: planned | parent: CE-EXOP-00 | objective: Deliver multi-operation objective and candidate frontier exactly within the contracts, boundaries, evidence rules, and deferred-work limits in docs/CE_EXOP_PROGRAM.md.
...
- `CE-EXOP-94` | kind: validation_task | status: planned | parent: CE-EXOP-00 | objective: Deliver greedy strategy validation exactly within the contracts, boundaries, evidence rules, and deferred-work limits in docs/CE_EXOP_PROGRAM.md.
...
- `CE-EXOP-100` | kind: workstream | status: planned | parent: CE-EXOP-00 | objective: Deliver affinity coarsening and hierarchy construction exactly within the contracts, boundaries, evidence rules, and deferred-work limits in docs/CE_EXOP_PROGRAM.md.
...
- `CE-EXOP-101` | kind: workstream | status: planned | parent: CE-EXOP-00 | objective: Deliver coarse solve, uncoarsening, and local refinement exactly within the contracts, boundaries, evidence rules, and deferred-work limits in docs/CE_EXOP_PROGRAM.md.
...
- `CE-EXOP-102` | kind: workstream | status: planned | parent: CE-EXOP-00 | objective: Deliver provenance, bounded-memory, and streaming implementation exactly within the contracts, boundaries, evidence rules, and deferred-work limits in docs/CE_EXOP_PROGRAM.md.
...
- `CE-EXOP-103` | kind: workstream | status: planned | parent: CE-EXOP-00 | objective: Deliver multi-operation and work-window support exactly within the contracts, boundaries, evidence rules, and deferred-work limits in docs/CE_EXOP_PROGRAM.md.
...
- `CE-EXOP-104` | kind: validation_task | status: planned | parent: CE-EXOP-00 | objective: Deliver multilevel strategy validation exactly within the contracts, boundaries, evidence rules, and deferred-work limits in docs/CE_EXOP_PROGRAM.md.
...
- `CE-EXOP-110` | kind: workstream | status: planned | parent: CE-EXOP-00 | objective: Deliver overlapping source dictionary and replication contract exactly within the contracts, boundaries, evidence rules, and deferred-work limits in docs/CE_EXOP_PROGRAM.md.
- `CE-EXOP-111` | kind: workstream | status: planned | parent: CE-EXOP-00 | objective: Deliver bounded-overlap solver with complete duplication cost exactly within the contracts, boundaries, evidence rules, and deferred-work limits in docs/CE_EXOP_PROGRAM.md.
- `CE-EXOP-112` | kind: workstream | status: planned | parent: CE-EXOP-00 | objective: Deliver exact logical maps, values, and gradient reconciliation exactly within the contracts, boundaries, evidence rules, and deferred-work limits in docs/CE_EXOP_PROGRAM.md.
- `CE-EXOP-113` | kind: workstream | status: planned | parent: CE-EXOP-00 | objective: Deliver work-window behavior and disjoint fallback exactly within the contracts, boundaries, evidence rules, and deferred-work limits in docs/CE_EXOP_PROGRAM.md.
- `CE-EXOP-114` | kind: validation_task | status: planned | parent: CE-EXOP-00 | objective: Deliver overlap strategy validation exactly within the contracts, boundaries, evidence rules, and deferred-work limits in docs/CE_EXOP_PROGRAM.md.
- `CE-EXOP-120` | kind: workstream | status: planned | parent: CE-EXOP-00 | objective: Deliver exact small-problem optimizer oracle exactly within the contracts, boundaries, evidence rules, and deferred-work limits in docs/CE_EXOP_PROGRAM.md.
...
- `CE-EXOP-121` | kind: workstream | status: planned | parent: CE-EXOP-00 | objective: Deliver branch-and-bound/exhaustive objective validation exactly within the contracts, boundaries, evidence rules, and deferred-work limits in docs/CE_EXOP_PROGRAM.md.
...
- `CE-EXOP-122` | kind: workstream | status: planned | parent: CE-EXOP-00 | objective: Deliver strategy portfolio, deduplication, and pareto frontier exactly within the contracts, boundaries, evidence rules, and deferred-work limits in docs/CE_EXOP_PROGRAM.md.
...
- `CE-EXOP-123` | kind: workstream | status: planned | parent: CE-EXOP-00 | objective: Deliver serializable external snapshot and dummy alternative solver exactly within the contracts, boundaries, evidence rules, and deferred-work limits in docs/CE_EXOP_PROGRAM.md.
...
- `CE-EXOP-124` | kind: workstream | status: planned | parent: CE-EXOP-00 | objective: Deliver freeze optimizer portfolio exactly within the contracts, boundaries, evidence rules, and deferred-work limits in docs/CE_EXOP_PROGRAM.md.
...
- `CE-EXOP-130` | kind: workstream | status: planned | parent: CE-EXOP-00 | objective: Deliver batched gpu proposal-scoring primitive exactly within the contracts, boundaries, evidence rules, and deferred-work limits in docs/CE_EXOP_PROGRAM.md.
...
- `CE-EXOP-131` | kind: workstream | status: planned | parent: CE-EXOP-00 | objective: Deliver gpu exact-census and local-delta primitive exactly within the contracts, boundaries, evidence rules, and deferred-work limits in docs/CE_EXOP_PROGRAM.md.
- `CE-EXOP-132` | kind: workstream | status: planned | parent: CE-EXOP-00 | objective: Deliver cpu/gpu parity, asynchronous use, and resource receipt exactly within the contracts, boundaries, evidence rules, and deferred-work limits in docs/CE_EXOP_PROGRAM.md.
- `CE-EXOP-133` | kind: validation_task | status: planned | parent: CE-EXOP-00 | objective: Deliver device-assisted optimizer disposition exactly within the contracts, boundaries, evidence rules, and deferred-work limits in docs/CE_EXOP_PROGRAM.md.
- `CE-EXOP-140` | kind: workstream | status: planned | parent: CE-EXOP-00 | objective: Deliver common logical/projection value-plane contract exactly within the contracts, boundaries, evidence rules, and deferred-work limits in docs/CE_EXOP_PROGRAM.md.
...
- `CE-EXOP-141` | kind: workstream | status: planned | parent: CE-EXOP-00 | objective: Deliver composite projection-primary trainable values exactly within the contracts, boundaries, evidence rules, and deferred-work limits in docs/CE_EXOP_PROGRAM.md.
...
- `CE-EXOP-142` | kind: workstream | status: planned | parent: CE-EXOP-00 | objective: Deliver generation publication and direct projection-order gradients exactly within the contracts, boundaries, evidence rules, and deferred-work limits in docs/CE_EXOP_PROGRAM.md.
...
- `CE-EXOP-143` | kind: workstream | status: planned | parent: CE-EXOP-00 | objective: Deliver canonical import/export, dirty updates, and permanent holes exactly within the contracts, boundaries, evidence rules, and deferred-work limits in docs/CE_EXOP_PROGRAM.md.
...
- `CE-EXOP-144` | kind: workstream | status: planned | parent: CE-EXOP-00 | objective: Deliver value-pack portfolio and dynamic gate coexistence exactly within the contracts, boundaries, evidence rules, and deferred-work limits in docs/CE_EXOP_PROGRAM.md.
...
- `CE-EXOP-145` | kind: workstream | status: planned | parent: CE-EXOP-00 | objective: Deliver freeze projection value planes exactly within the contracts, boundaries, evidence rules, and deferred-work limits in docs/CE_EXOP_PROGRAM.md.
- `CE-EXOP-150` | kind: workstream | status: planned | parent: CE-EXOP-00 | objective: Deliver register the profiler-visible sm70 apply inventory exactly within the contracts, boundaries, evidence rules, and deferred-work limits in docs/CE_EXOP_PROGRAM.md.
...
- `CE-EXOP-151` | kind: workstream | status: planned | parent: CE-EXOP-00 | objective: Deliver n=16 and differentiated n=32 output-owner variants exactly within the contracts, boundaries, evidence rules, and deferred-work limits in docs/CE_EXOP_PROGRAM.md.
...
- `CE-EXOP-152` | kind: workstream | status: planned | parent: CE-EXOP-00 | objective: Deliver n=64 direct-global and shared-a variants exactly within the contracts, boundaries, evidence rules, and deferred-work limits in docs/CE_EXOP_PROGRAM.md.
...
- `CE-EXOP-153` | kind: workstream | status: planned | parent: CE-EXOP-00 | objective: Deliver software-pipelined n=64 and n>64 panelized variants exactly within the contracts, boundaries, evidence rules, and deferred-work limits in docs/CE_EXOP_PROGRAM.md.
...
- `CE-EXOP-154` | kind: workstream | status: planned | parent: CE-EXOP-00 | objective: Deliver alternate legal wmma shapes and ptx m8n8k4 experiment exactly within the contracts, boundaries, evidence rules, and deferred-work limits in docs/CE_EXOP_PROGRAM.md.
- `CE-EXOP-155` | kind: workstream | status: planned | parent: CE-EXOP-00 | objective: Deliver candidate registration and profiling receipts exactly within the contracts, boundaries, evidence rules, and deferred-work limits in docs/CE_EXOP_PROGRAM.md.
- `CE-EXOP-156` | kind: validation_task | status: planned | parent: CE-EXOP-00 | objective: Deliver apply portfolio correctness exactly within the contracts, boundaries, evidence rules, and deferred-work limits in docs/CE_EXOP_PROGRAM.md.
- `CE-EXOP-160` | kind: workstream | status: planned | parent: CE-EXOP-00 | objective: Deliver scalable residual baseline and degree partitioning exactly within the contracts, boundaries, evidence rules, and deferred-work limits in docs/CE_EXOP_PROGRAM.md.
- `CE-EXOP-161` | kind: workstream | status: planned | parent: CE-EXOP-00 | objective: Deliver warp-per-row and cta high-degree variants exactly within the contracts, boundaries, evidence rules, and deferred-work limits in docs/CE_EXOP_PROGRAM.md.
- `CE-EXOP-162` | kind: workstream | status: planned | parent: CE-EXOP-00 | objective: Deliver pinned feature-major residual variant exactly within the contracts, boundaries, evidence rules, and deferred-work limits in docs/CE_EXOP_PROGRAM.md.
- `CE-EXOP-163` | kind: workstream | status: planned | parent: CE-EXOP-00 | objective: Deliver same-output-owner fused mma residual exactly within the contracts, boundaries, evidence rules, and deferred-work limits in docs/CE_EXOP_PROGRAM.md.
- `CE-EXOP-164` | kind: workstream | status: planned | parent: CE-EXOP-00 | objective: Deliver separate and concurrent residual alternatives exactly within the contracts, boundaries, evidence rules, and deferred-work limits in docs/CE_EXOP_PROGRAM.md.
- `CE-EXOP-165` | kind: validation_task | status: planned | parent: CE-EXOP-00 | objective: Deliver residual registration and exact validation exactly within the contracts, boundaries, evidence rules, and deferred-work limits in docs/CE_EXOP_PROGRAM.md.
- `CE-EXOP-170` | kind: workstream | status: planned | parent: CE-EXOP-00 | objective: Deliver explicit transpose cover and source-owner schedule exactly within the contracts, boundaries, evidence rules, and deferred-work limits in docs/CE_EXOP_PROGRAM.md.
- `CE-EXOP-171` | kind: workstream | status: planned | parent: CE-EXOP-00 | objective: Deliver sparse and mma transpose candidates exactly within the contracts, boundaries, evidence rules, and deferred-work limits in docs/CE_EXOP_PROGRAM.md.
- `CE-EXOP-172` | kind: workstream | status: planned | parent: CE-EXOP-00 | objective: Deliver global identity, local maps, and direct gradient order exactly within the contracts, boundaries, evidence rules, and deferred-work limits in docs/CE_EXOP_PROGRAM.md.
- `CE-EXOP-173` | kind: workstream | status: planned | parent: CE-EXOP-00 | objective: Deliver planner/catalog/resource integration exactly within the contracts, boundaries, evidence rules, and deferred-work limits in docs/CE_EXOP_PROGRAM.md.
- `CE-EXOP-174` | kind: validation_task | status: planned | parent: CE-EXOP-00 | objective: Deliver transpose correctness and scale validation exactly within the contracts, boundaries, evidence rules, and deferred-work limits in docs/CE_EXOP_PROGRAM.md.
- `CE-EXOP-180` | kind: workstream | status: planned | parent: CE-EXOP-00 | objective: Deliver sparse cooperative contraction variants exactly within the contracts, boundaries, evidence rules, and deferred-work limits in docs/CE_EXOP_PROGRAM.md.
- `CE-EXOP-181` | kind: workstream | status: planned | parent: CE-EXOP-00 | objective: Deliver rectangular mma contraction plus exact residual exactly within the contracts, boundaries, evidence rules, and deferred-work limits in docs/CE_EXOP_PROGRAM.md.
- `CE-EXOP-182` | kind: workstream | status: planned | parent: CE-EXOP-00 | objective: Deliver projection-native outputs and direct edge gradients exactly within the contracts, boundaries, evidence rules, and deferred-work limits in docs/CE_EXOP_PROGRAM.md.
- `CE-EXOP-183` | kind: workstream | status: planned | parent: CE-EXOP-00 | objective: Deliver catalog, planner, and resource integration exactly within the contracts, boundaries, evidence rules, and deferred-work limits in docs/CE_EXOP_PROGRAM.md.
- `CE-EXOP-184` | kind: validation_task | status: planned | parent: CE-EXOP-00 | objective: Deliver contraction correctness across d regimes exactly within the contracts, boundaries, evidence rules, and deferred-work limits in docs/CE_EXOP_PROGRAM.md.
- `CE-EXOP-190` | kind: workstream | status: planned | parent: CE-EXOP-00 | objective: Deliver segment plan v2 and expanded operation suite exactly within the contracts, boundaries, evidence rules, and deferred-work limits in docs/CE_EXOP_PROGRAM.md.
- `CE-EXOP-191` | kind: workstream | status: planned | parent: CE-EXOP-00 | objective: Deliver warp, cta, and large-segment mechanisms exactly within the contracts, boundaries, evidence rules, and deferred-work limits in docs/CE_EXOP_PROGRAM.md.
- `CE-EXOP-192` | kind: workstream | status: planned | parent: CE-EXOP-00 | objective: Deliver normalization suite and backward operations exactly within the contracts, boundaries, evidence rules, and deferred-work limits in docs/CE_EXOP_PROGRAM.md.
- `CE-EXOP-193` | kind: workstream | status: planned | parent: CE-EXOP-00 | objective: Deliver cover-native partitioned segment execution exactly within the contracts, boundaries, evidence rules, and deferred-work limits in docs/CE_EXOP_PROGRAM.md.
- `CE-EXOP-194` | kind: workstream | status: planned | parent: CE-EXOP-00 | objective: Deliver catalog, planner, and profiling integration exactly within the contracts, boundaries, evidence rules, and deferred-work limits in docs/CE_EXOP_PROGRAM.md.
- `CE-EXOP-195` | kind: validation_task | status: planned | parent: CE-EXOP-00 | objective: Deliver segment correctness and numerical validation exactly within the contracts, boundaries, evidence rules, and deferred-work limits in docs/CE_EXOP_PROGRAM.md.
- `CE-EXOP-200` | kind: workstream | status: planned | parent: CE-EXOP-00 | objective: Deliver general edge-map and per-edge gate exactly within the contracts, boundaries, evidence rules, and deferred-work limits in docs/CE_EXOP_PROGRAM.md.
...
- `CE-EXOP-201` | kind: workstream | status: planned | parent: CE-EXOP-00 | objective: Deliver source, destination, component, and factorized gates exactly within the contracts, boundaries, evidence rules, and deferred-work limits in docs/CE_EXOP_PROGRAM.md.
...
- `CE-EXOP-202` | kind: workstream | status: planned | parent: CE-EXOP-00 | objective: Deliver dynamic support mask over stable topology exactly within the contracts, boundaries, evidence rules, and deferred-work limits in docs/CE_EXOP_PROGRAM.md.
...
- `CE-EXOP-203` | kind: workstream | status: planned | parent: CE-EXOP-00 | objective: Deliver sparse axis update operation family exactly within the contracts, boundaries, evidence rules, and deferred-work limits in docs/CE_EXOP_PROGRAM.md.
...
- `CE-EXOP-204` | kind: validation_task | status: planned | parent: CE-EXOP-00 | objective: Deliver gate/update registration and validation exactly within the contracts, boundaries, evidence rules, and deferred-work limits in docs/CE_EXOP_PROGRAM.md.
- `CE-EXOP-210` | kind: workstream | status: planned | parent: CE-EXOP-00 | objective: Deliver typed relation-bundle plan v2 exactly within the contracts, boundaries, evidence rules, and deferred-work limits in docs/CE_EXOP_PROGRAM.md.
- `CE-EXOP-211` | kind: workstream | status: planned | parent: CE-EXOP-00 | objective: Deliver sequential and grouped-launch bundle candidates exactly within the contracts, boundaries, evidence rules, and deferred-work limits in docs/CE_EXOP_PROGRAM.md.
- `CE-EXOP-212` | kind: workstream | status: planned | parent: CE-EXOP-00 | objective: Deliver shared-destination output-owner bundle candidate exactly within the contracts, boundaries, evidence rules, and deferred-work limits in docs/CE_EXOP_PROGRAM.md.
- `CE-EXOP-213` | kind: workstream | status: planned | parent: CE-EXOP-00 | objective: Deliver materialized and persistent-order relation chains exactly within the contracts, boundaries, evidence rules, and deferred-work limits in docs/CE_EXOP_PROGRAM.md.
- `CE-EXOP-214` | kind: workstream | status: planned | parent: CE-EXOP-00 | objective: Deliver relation-moments paired traversal exactly within the contracts, boundaries, evidence rules, and deferred-work limits in docs/CE_EXOP_PROGRAM.md.
- `CE-EXOP-215` | kind: validation_task | status: planned | parent: CE-EXOP-00 | objective: Deliver bundle/chain registration and validation exactly within the contracts, boundaries, evidence rules, and deferred-work limits in docs/CE_EXOP_PROGRAM.md.
- `CE-EXOP-220` | kind: workstream | status: planned | parent: CE-EXOP-00 | objective: Deliver prepared stage-graph compatibility and composition exactly within the contracts, boundaries, evidence rules, and deferred-work limits in docs/CE_EXOP_PROGRAM.md.
- `CE-EXOP-221` | kind: workstream | status: planned | parent: CE-EXOP-00 | objective: Deliver value-pack/apply and apply/epilogue fusions exactly within the contracts, boundaries, evidence rules, and deferred-work limits in docs/CE_EXOP_PROGRAM.md.
- `CE-EXOP-222` | kind: workstream | status: planned | parent: CE-EXOP-00 | objective: Deliver mma plus same-owner residual fusion exactly within the contracts, boundaries, evidence rules, and deferred-work limits in docs/CE_EXOP_PROGRAM.md.
- `CE-EXOP-223` | kind: workstream | status: planned | parent: CE-EXOP-00 | objective: Deliver contract/map and contract/segment-statistic fusions exactly within the contracts, boundaries, evidence rules, and deferred-work limits in docs/CE_EXOP_PROGRAM.md.
- `CE-EXOP-224` | kind: workstream | status: planned | parent: CE-EXOP-00 | objective: Deliver normalize/apply and full sparse-exchange composition exactly within the contracts, boundaries, evidence rules, and deferred-work limits in docs/CE_EXOP_PROGRAM.md.
- `CE-EXOP-225` | kind: workstream | status: planned | parent: CE-EXOP-00 | objective: Deliver bundle-output and relation-moments fusions exactly within the contracts, boundaries, evidence rules, and deferred-work limits in docs/CE_EXOP_PROGRAM.md.
- `CE-EXOP-226` | kind: validation_task | status: planned | parent: CE-EXOP-00 | objective: Deliver fused/unfused equivalence and registration exactly within the contracts, boundaries, evidence rules, and deferred-work limits in docs/CE_EXOP_PROGRAM.md.
- `CE-EXOP-230` | kind: workstream | status: planned | parent: CE-EXOP-00 | objective: Deliver generic planner-selected training program v2 exactly within the contracts, boundaries, evidence rules, and deferred-work limits in docs/CE_EXOP_PROGRAM.md.
- `CE-EXOP-231` | kind: workstream | status: planned | parent: CE-EXOP-00 | objective: Deliver forward, transpose, and edge-gradient closure exactly within the contracts, boundaries, evidence rules, and deferred-work limits in docs/CE_EXOP_PROGRAM.md.
- `CE-EXOP-232` | kind: workstream | status: planned | parent: CE-EXOP-00 | objective: Deliver logical-primary versus projection-primary modes exactly within the contracts, boundaries, evidence rules, and deferred-work limits in docs/CE_EXOP_PROGRAM.md.
- `CE-EXOP-233` | kind: workstream | status: planned | parent: CE-EXOP-00 | objective: Deliver generation readiness and persistent execution order exactly within the contracts, boundaries, evidence rules, and deferred-work limits in docs/CE_EXOP_PROGRAM.md.
- `CE-EXOP-234` | kind: workstream | status: planned | parent: CE-EXOP-00 | objective: Deliver graph capture and update-policy separation exactly within the contracts, boundaries, evidence rules, and deferred-work limits in docs/CE_EXOP_PROGRAM.md.
- `CE-EXOP-235` | kind: workstream | status: planned | parent: CE-EXOP-00 | objective: Deliver freeze training program v2 exactly within the contracts, boundaries, evidence rules, and deferred-work limits in docs/CE_EXOP_PROGRAM.md.
- `CE-EXOP-240` | kind: validation_task | status: planned | parent: CE-EXOP-00 | objective: Deliver legacy and baseline regression suite exactly within the contracts, boundaries, evidence rules, and deferred-work limits in docs/CE_EXOP_PROGRAM.md.
- `CE-EXOP-241` | kind: validation_task | status: planned | parent: CE-EXOP-00 | objective: Deliver global-64/local-index and linear-complexity tests exactly within the contracts, boundaries, evidence rules, and deferred-work limits in docs/CE_EXOP_PROGRAM.md.
- `CE-EXOP-242` | kind: validation_task | status: planned | parent: CE-EXOP-00 | objective: Deliver optimizer determinism and oracle-quality tests exactly within the contracts, boundaries, evidence rules, and deferred-work limits in docs/CE_EXOP_PROGRAM.md.
- `CE-EXOP-243` | kind: validation_task | status: planned | parent: CE-EXOP-00 | objective: Deliver catalog, acquisition, artifact, and provider negative tests exactly within the contracts, boundaries, evidence rules, and deferred-work limits in docs/CE_EXOP_PROGRAM.md.
- `CE-EXOP-244` | kind: validation_task | status: planned | parent: CE-EXOP-00 | objective: Deliver static architecture and no-new-stl audits exactly within the contracts, boundaries, evidence rules, and deferred-work limits in docs/CE_EXOP_PROGRAM.md.
- `CE-EXOP-245` | kind: validation_task | status: planned | parent: CE-EXOP-00 | objective: Deliver full integrated host acceptance exactly within the contracts, boundaries, evidence rules, and deferred-work limits in docs/CE_EXOP_PROGRAM.md.
- `CE-EXOP-250` | kind: validation_task | status: planned | parent: CE-EXOP-00 | objective: Deliver candidate matrix, widths, tails, and output ownership exactly within the contracts, boundaries, evidence rules, and deferred-work limits in docs/CE_EXOP_PROGRAM.md.
- `CE-EXOP-251` | kind: validation_task | status: planned | parent: CE-EXOP-00 | objective: Deliver dynamic values, gates, and projection-primary generations exactly within the contracts, boundaries, evidence rules, and deferred-work limits in docs/CE_EXOP_PROGRAM.md.
- `CE-EXOP-252` | kind: validation_task | status: planned | parent: CE-EXOP-00 | objective: Deliver transpose, contraction, and gradient validation exactly within the contracts, boundaries, evidence rules, and deferred-work limits in docs/CE_EXOP_PROGRAM.md.
- `CE-EXOP-253` | kind: validation_task | status: planned | parent: CE-EXOP-00 | objective: Deliver segment, bundle, chain, and fusion equivalence exactly within the contracts, boundaries, evidence rules, and deferred-work limits in docs/CE_EXOP_PROGRAM.md.
- `CE-EXOP-254` | kind: validation_task | status: planned | parent: CE-EXOP-00 | objective: Deliver streams, graphs, sanitizers, hot-path and scale validation exactly within the contracts, boundaries, evidence rules, and deferred-work limits in docs/CE_EXOP_PROGRAM.md.
- `CE-EXOP-255` | kind: validation_task | status: planned | parent: CE-EXOP-00 | objective: Deliver full integrated volta cuda acceptance exactly within the contracts, boundaries, evidence rules, and deferred-work limits in docs/CE_EXOP_PROGRAM.md.
- `CE-EXOP-260` | kind: workstream | status: planned | parent: CE-EXOP-00 | objective: Deliver synthetic profiler corpus and candidate matrix exactly within the contracts, boundaries, evidence rules, and deferred-work limits in docs/CE_EXOP_PROGRAM.md.
- `CE-EXOP-261` | kind: workstream | status: planned | parent: CE-EXOP-00 | objective: Deliver stage, marker, identity, and resource-receipt validation exactly within the contracts, boundaries, evidence rules, and deferred-work limits in docs/CE_EXOP_PROGRAM.md.
- `CE-EXOP-262` | kind: workstream | status: planned | parent: CE-EXOP-00 | objective: Deliver lineinfo and optional-marker profiler smoke exactly within the contracts, boundaries, evidence rules, and deferred-work limits in docs/CE_EXOP_PROGRAM.md.
- `CE-EXOP-263` | kind: workstream | status: planned | parent: CE-EXOP-00 | objective: Deliver generic cellshard-facing export fixture exactly within the contracts, boundaries, evidence rules, and deferred-work limits in docs/CE_EXOP_PROGRAM.md.
- `CE-EXOP-264` | kind: workstream | status: planned | parent: CE-EXOP-00 | objective: Deliver deferred nsight/data/preprint requirements manifest exactly within the contracts, boundaries, evidence rules, and deferred-work limits in docs/CE_EXOP_PROGRAM.md.
- `CE-EXOP-265` | kind: validation_task | status: planned | parent: CE-EXOP-00 | objective: Deliver profiler-readiness acceptance exactly within the contracts, boundaries, evidence rules, and deferred-work limits in docs/CE_EXOP_PROGRAM.md.
- `CE-EXOP-270` | kind: integration_task | status: planned | parent: CE-EXOP-00 | objective: Deliver integrate core abi fan-in exactly within the contracts, boundaries, evidence rules, and deferred-work limits in docs/CE_EXOP_PROGRAM.md.
- `CE-EXOP-271` | kind: integration_task | status: planned | parent: CE-EXOP-00 | objective: Deliver integrate program/build/acquisition/profile execution path exactly within the contracts, boundaries, evidence rules, and deferred-work limits in docs/CE_EXOP_PROGRAM.md.
- `CE-EXOP-272` | kind: validation_task | status: planned | parent: CE-EXOP-00 | objective: Deliver core integration checkpoint exactly within the contracts, boundaries, evidence rules, and deferred-work limits in docs/CE_EXOP_PROGRAM.md.
- `CE-EXOP-273` | kind: integration_task | status: planned | parent: CE-EXOP-00 | objective: Deliver integrate optimizer portfolio exactly within the contracts, boundaries, evidence rules, and deferred-work limits in docs/CE_EXOP_PROGRAM.md.
- `CE-EXOP-274` | kind: integration_task | status: planned | parent: CE-EXOP-00 | objective: Deliver integrate scale, values, semantic geometry, and physical covers exactly within the contracts, boundaries, evidence rules, and deferred-work limits in docs/CE_EXOP_PROGRAM.md.
- `CE-EXOP-275` | kind: validation_task | status: planned | parent: CE-EXOP-00 | objective: Deliver geometry integration checkpoint exactly within the contracts, boundaries, evidence rules, and deferred-work limits in docs/CE_EXOP_PROGRAM.md.
- `CE-EXOP-276` | kind: integration_task | status: planned | parent: CE-EXOP-00 | objective: Deliver integrate apply, residual, transpose, and contraction exactly within the contracts, boundaries, evidence rules, and deferred-work limits in docs/CE_EXOP_PROGRAM.md.
- `CE-EXOP-277` | kind: integration_task | status: planned | parent: CE-EXOP-00 | objective: Deliver integrate segments, gates, updates, bundles, and chains exactly within the contracts, boundaries, evidence rules, and deferred-work limits in docs/CE_EXOP_PROGRAM.md.
- `CE-EXOP-278` | kind: integration_task | status: planned | parent: CE-EXOP-00 | objective: Deliver integrate fusions and training program exactly within the contracts, boundaries, evidence rules, and deferred-work limits in docs/CE_EXOP_PROGRAM.md.
- `CE-EXOP-279` | kind: validation_task | status: planned | parent: CE-EXOP-00 | objective: Deliver freeze operation portfolio exactly within the contracts, boundaries, evidence rules, and deferred-work limits in docs/CE_EXOP_PROGRAM.md.
- `CE-EXOP-280` | kind: integration_task | status: planned | parent: CE-EXOP-00 | objective: Deliver integrate complete ce-exop source and package surface exactly within the contracts, boundaries, evidence rules, and deferred-work limits in docs/CE_EXOP_PROGRAM.md.
- `CE-EXOP-281` | kind: integration_task | status: planned | parent: CE-EXOP-00 | objective: Deliver run full integrated regression and evidence generation exactly within the contracts, boundaries, evidence rules, and deferred-work limits in docs/CE_EXOP_PROGRAM.md.
- `CE-EXOP-282` | kind: validation_task | status: planned | parent: CE-EXOP-00 | objective: Deliver profiler-ready system checkpoint exactly within the contracts, boundaries, evidence rules, and deferred-work limits in docs/CE_EXOP_PROGRAM.md.
- `CE-EXOP-286` | kind: workstream | status: planned | parent: CE-EXOP-00 | objective: Deliver update authoritative documentation spine exactly within the contracts, boundaries, evidence rules, and deferred-work limits in docs/CE_EXOP_PROGRAM.md.
- `CE-EXOP-287` | kind: workstream | status: planned | parent: CE-EXOP-00 | objective: Deliver publish deferred profiling/data/preprint handoff exactly within the contracts, boundaries, evidence rules, and deferred-work limits in docs/CE_EXOP_PROGRAM.md.
- `CE-EXOP-288` | kind: validation_task | status: planned | parent: CE-EXOP-00 | objective: Deliver final acceptance audit exactly within the contracts, boundaries, evidence rules, and deferred-work limits in docs/CE_EXOP_PROGRAM.md.
- `CE-EXOP-289` | kind: validation_task | status: planned | parent: CE-EXOP-00 | objective: Deliver verify ce-amp interlock exactly within the contracts, boundaries, evidence rules, and deferred-work limits in docs/CE_EXOP_PROGRAM.md.
- `CE-EXOP-290` | kind: validation_task | status: planned | parent: CE-EXOP-00 | objective: Deliver close ce-exop exactly within the contracts, boundaries, evidence rules, and deferred-work limits in docs/CE_EXOP_PROGRAM.md.
