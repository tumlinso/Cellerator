...
- `CE-JBC-V06` | kind: integration_task | status: in_progress | parent: - | objective: Integrate and publish the Cellerator JBC handoff. Deliver this as one isolated, reviewable step in the Cellerator exact verification, profiling, packaging, and integration workstream.
