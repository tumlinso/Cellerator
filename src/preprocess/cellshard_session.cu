...
csd::blocked_ell_view device_view_from_record(const csd::partition_record<::cellerator::matrix::blocked_ell> &record,
                                              status *out) {
...
csd::sliced_ell_view device_view_from_record(const csd::partition_record<::cellerator::matrix::sliced_ell> &record,
                                             status *out) {
...
int preprocess_cellshard_session_all_gpus(const preprocess_cellshard_session_options *options,
    ...
    if (summary.matrix_format == "blocked_ell") {
        ok = run_layout<::cellerator::matrix::blocked_ell, csd::blocked_ell_view>(
            summary, native_sparse_blocked_ell, options, result, out);
    } else if (summary.matrix_format == "sliced_ell") {
        ok = run_layout<::cellerator::matrix::sliced_ell, csd::sliced_ell_view>(
