...
- `cellpack-bp06-11-parallel-execution` | status: in_progress | execution: claimed | owner: coordination | file: `todos/cellpack-bp06-11-parallel-execution.md` | next: Both Phase C gates are published and leases released; Barrier C combined validation/commit/push is the sole next action.
- `cellpack-data-inferred-block-packing-roadmap` | status: in_progress | execution: claimed | owner: coordination | file: `todos/cellpack-data-inferred-block-packing-roadmap.md` | next: Do not implement from this parent. Appoint the Barrier C integrator; do not open Phase D early.
...
- `cellpack-bp08-warp-tiles` | status: in_progress | execution: idle | owner: unassigned | file: `todos/cellpack-bp08-warp-tiles.md` | next: `CP08_HOST_ABI_READY` is published; await Barrier C and do not claim CUDA Phase D early.
