...
- `cellpack-bp06-11-parallel-execution` | status: in_progress | execution: claimed | owner: coordination | file: `todos/cellpack-bp06-11-parallel-execution.md` | next: Barrier B is integrated; fork ready CP-BP-08 host tiles and idle CP-BP-11 record-level held-out adapters as the Phase C pair.
...
- `cellpack-bp08-warp-tiles` | status: planned | execution: ready | owner: unassigned | file: `todos/cellpack-bp08-warp-tiles.md` | next: Claim Phase C host ABI/reference only; publish `CP08_HOST_ABI_READY`, release, and stop before CUDA Phase D.
...
- `cellpack-bp11-statistical-validation` | status: in_progress | execution: idle | owner: unassigned | file: `todos/cellpack-bp11-statistical-validation.md` | next: Phase C is open for frozen-plan/record-level held-out adapters; publish `CP11_HELDOUT_READY`, release, and stop.
