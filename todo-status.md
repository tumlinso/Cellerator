...
- `cellpack-bp06-11-parallel-execution` | status: in_progress | execution: claimed | owner: coordination | file: `todos/cellpack-bp06-11-parallel-execution.md` | next: Barrier A integrated; fork CP-BP-06 Phase B and CP-BP-07 under the recorded interlocks, then stop at Barrier B.
- `cellpack-data-inferred-block-packing-roadmap` | status: in_progress | execution: claimed | owner: coordination | file: `todos/cellpack-data-inferred-block-packing-roadmap.md` | next: Do not implement from this parent. CP-BP-06 Phase B and CP-BP-07 are the ready, unclaimed parallel frontier.
...
- `cellpack-bp06-cell-block-records` | status: in_progress | execution: idle | owner: unassigned | file: `todos/cellpack-bp06-cell-block-records.md` | next: Phase B ready: claim CUDA detect/scan/emit only; stop at `CP06_DEVICE_READY` without absorbing row ordering.
- `cellpack-bp07-local-cell-ordering` | status: planned | execution: ready | owner: unassigned | file: `todos/cellpack-bp07-local-cell-ordering.md` | next: Ready after Barrier A: consume CP-BP-06 host records read-only and emit bounded reversible local order maps.
...
- `cellpack-bp11-statistical-validation` | status: in_progress | execution: idle | owner: unassigned | file: `todos/cellpack-bp11-statistical-validation.md` | next: Foundations integrated; remain idle until the coordinator explicitly opens Phase C record-level held-out adapters.
