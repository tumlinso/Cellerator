...
- `cellpack-bp06-11-parallel-execution` | status: in_progress | execution: claimed | owner: coordination | file: `todos/cellpack-bp06-11-parallel-execution.md` | next: Both Phase E gates are published and released. Barrier E combined validation/integration is the sole next action.
- `cellpack-data-inferred-block-packing-roadmap` | status: in_progress | execution: claimed | owner: coordination | file: `todos/cellpack-data-inferred-block-packing-roadmap.md` | next: Do not implement from this parent. Both Phase E gates are ready; perform Barrier E before activating CP-BP-10/12/13 or Phase F.
...
- `cellpack-bp09-native-runtime-consumers` | status: in_progress | execution: idle | owner: unassigned | file: `todos/cellpack-bp09-native-runtime-consumers.md` | next: `CP09_RUNTIME_READY` published; do not resume. Barrier E integrator validates, commits/pushes, then closes CP-BP-09.
...
- `cellpack-bp11-statistical-validation` | status: in_progress | execution: idle | owner: unassigned | file: `todos/cellpack-bp11-statistical-validation.md` | next: `CP11_TILE_BOOTSTRAP_READY` published; do not resume. Barrier E integrates both Phase E streams before Phase F opens.
