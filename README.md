...
- Current MTX-dataset ingest is bounded-memory and SSD-aware: it emits the canonical `dataset.csh5`, spills bounded build artifacts to a local spool, and leaves shape-changing preprocess compaction to the later workbench preprocess/finalize path.
